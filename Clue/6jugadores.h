...
int seis_jugadores(int valorUsuario, char nombre[valorUsuario][2048]){
...
for(j=1; j<7; j++){
  ...
  for(w=0;w<1;w++){
      ...
      else if(jugador == 3){contador_3++;}
      else if(jugador == 4){contador_4++;}
      else if(jugador == 5){contador_5++;}
      else{contador_6++;}
    }
  ...
  if (jugador == 1 && estado_jugador1[1] == loser[0]){
    if (estado_jugador1[1] == loser[0] && estado_jugador2[1] == loser[0] && estado_jugador3[1] == loser[0] && estado_jugador4[1] == loser[0] && estado_jugador5[1] == loser[0] && estado_jugador6[1]== loser[0]){
  ...
  else if (jugador == 4 && estado_jugador4[1] == loser[0]){
    if (estado_jugador1[1] == loser[0] && estado_jugador2[1] == loser[0] && estado_jugador3[1] == loser[0] && estado_jugador4[1] == loser[0] && estado_jugador5[1] == loser[0] && estado_jugador6[1]== loser[0]){
    printf("Todos los jugadores han perdido!!! Buena suerte para la próxima!!!");
    j=7;
    }
  ...
  else if (jugador == 5 && estado_jugador5[1] == loser[0]){
    if (estado_jugador1[1] == loser[0] && estado_jugador2[1] == loser[0] && estado_jugador3[1] == loser[0] && estado_jugador4[1] == loser[0] && estado_jugador5[1] == loser[0] && estado_jugador6[1]== loser[0]){
    printf("Todos los jugadores han perdido!!! Buena suerte para la próxima!!!");
    j=7;
    }
  ...
  else if (jugador == 6 && estado_jugador6[1] == loser[0]){
    if (estado_jugador1[1] == loser[0] && estado_jugador2[1] == loser[0] && estado_jugador3[1] == loser[0] && estado_jugador4[1] == loser[0] && estado_jugador5[1] == loser[0] && estado_jugador6[1]== loser[0]){
    printf("Todos los jugadores han perdido!!! Buena suerte para la próxima!!!");
    j=7;
    }
  ...
  if (ch == 'r'){
    ...
    printf("El jugador %d >> %s ha perdido.\n", jugador, nombre[jugador]);
      if(jugador == 1){
        ...
        estado_jugador4[0] = nombre[jugador];
        estado_jugador4[1] = "Perdedor";
      }
      else if(jugador == 5){
        estado_jugador5[0] = nombre[jugador];
        estado_jugador5[1] = "Perdedor";
      }
      else{
        estado_jugador6[0] = nombre[jugador];
