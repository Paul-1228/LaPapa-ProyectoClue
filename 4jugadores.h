...
int cuatro_jugadores(int valorUsuario, char nombre[valorUsuario][2048]){
...
for(j=1; j<5; j++){
  ...
  if (jugador == 1 && estado_jugador1[1] == loser[0]){
    if (estado_jugador1[1] == loser[0] && estado_jugador2[1] == loser[0] && estado_jugador3[1] == loser[0] && estado_jugador4[1] == loser[0]){
