...
int cinco_jugadores(int valorUsuario, char nombre[valorUsuario][2048]){
...
/*    printf("\n Jugador 5:");
  ...
  if (jugador == 1 && estado_jugador1[1] == loser[0]){
    if (estado_jugador1[1] == loser[0] && estado_jugador2[1] == loser[0] && estado_jugador3[1] == loser[0] && estado_jugador4[1] == loser[0] && estado_jugador5[1] == loser[0]){
